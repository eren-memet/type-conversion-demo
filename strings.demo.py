...
s = '12345123451234512345'  * 5 
#print(s[::5])
result = name, surname, age, job ='Bora','Yılmaz', 32, 'mühendis'
...
#print(name + surname + job ) 

#result = "Benim adım "+name+ " " +surname+ ", Yaşım "+str(age) + ' mesleğim mühendistir'
